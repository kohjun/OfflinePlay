...
class EventDetailController(
    ...
    /**
     * PR155 — 이벤트 복제. 새 startAt/endAt 만 받고 나머지 metadata 는 원본 그대로.
     * 권한: owner / ADMIN.
     */
    ...
    fun cloneEvent(
        @AuthenticationPrincipal userId: Long,
        @PathVariable eventId: Long,
        @Valid @RequestBody request: CloneEventRequest,
    ): ApiResponse<EventResponse> =
        ApiResponse.created(eventService.cloneEvent(userId, eventId, request), "이벤트를 복제했어요.")
}
