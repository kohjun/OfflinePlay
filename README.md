...
- [docs/release-notes-local-bundle.md](docs/release-notes-local-bundle.md) — 다음 push 전 ship-readiness 노트 (현재 cycle: PR159~PR163)
...
- [docs/payment-refund-policy.md](docs/payment-refund-policy.md) — 결제/환불 상태 머신 + PG / webhook / hardening 세부
